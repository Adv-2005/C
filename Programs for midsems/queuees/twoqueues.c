...
// Push into Stack 2
void push2(twoqueues *ps, int value) {
    if (ps->top1 < ps->top2 - 1) {  // Check if space is available
...
// Display Stack 2
void displayStack2(twoqueues *ps) {
    if (ps->top2 < MAX) {
        printf("Stack 2: ");
